...
def train_parser():
    ...
    parser.add_argument("--ngpu",help="number of gpu devices used",type=int,default=3)
    parser.add_argument("--seed",help="random seed",type=int,default=42)
    parser.add_argument("--val_epoch",help="number of epochs before eval on val",type=int,default=20)
    parser.add_argument("--size",help="input images size",type=int,default=224)
    parser.add_argument("--resnet", help="whether use resnet12 as backbone or not",action="store_true", default=True)
    ...
    parser.add_argument("--train_way",help="training way",type=int,default=10) #10
...
class Train_Manager:
    ...
    def __init__(self,args,path_manager,train_func):
        ...
        self.logger = get_logger('vit+res1_afs_224%s.log' % (name)) # vit+res12_maxlr_
        self.save_path = 'vit+res1_afs_224_model_%s.pth' % (name)
        self.writer = SummaryWriter('vit+res1_afs_224_log_%s' % (name))
